...
/// Employee settings — mirror of the employer settings screen so both
/// roles get the same experience: notification toggles, privacy
/// placeholders, and a logout pill.
class EmployeeSettingsScreen extends StatefulWidget {
  final Map<String, dynamic> notifications;
  const EmployeeSettingsScreen({super.key, required this.notifications});
